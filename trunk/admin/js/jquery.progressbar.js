	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: 'components/com_jupgrade/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'components/com_jupgrade/images/progressbg_red.gif',
									30: 'components/com_jupgrade/images/progressbg_orange.gif',
									70: 'components/com_jupgrade/images/progressbg_green.gif'
								},
